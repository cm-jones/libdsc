...
/**
 * @file stack.h
 * @brief LIFO stack implementation similar to std::stack
 * 
 * This header provides a generic LIFO (Last In, First Out) stack implementation for C.
 * The stack automatically manages memory allocation and provides efficient
 ...
 * @return Number of elements currently stored in the stack, or 0 if stack is NULL
 * 
 ...
 * ```
 */
void *stack_top(dsc_stack const *stack);
